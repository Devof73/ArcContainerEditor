...
using ARC.Classes;
using ARC.Workers;
using ARC.Workers.ARC;
namespace ARC.Workers
{
    class PS3ARCWorker
    {
        ...
        {
            global::System.Collections.Generic.List<global::ARC.Workers.ARC.ArcEntry> list = new global::System.Collections.Generic.List<global::ARC.Workers.ARC.ArcEntry>();
            byte[] array = global::ARC.Workers.ARC.FileUtils.smethod_0(arcPath);
            ...
            if (array != null)
            {
                ...
                for (int i = 0; i < num; i++)
                {
                    ...
                    global::ARC.Workers.ARC.ArcEntry item = new global::ARC.Workers.ARC.ArcEntry(name, size, pos);
                    list.Add(item);
                }
            }
        ...
        private void method_1(string string_0, global::System.Collections.Generic.List<global::ARC.Workers.ARC.ArcEntry> list_0, global::System.IO.MemoryStream memoryStream_0)
        {
            foreach (global::ARC.Workers.ARC.ArcEntry arcEntry in list_0)
            {
                ...
                global::ARC.Workers.ARC.FileUtils.WriteFile(array, text);
            }
        }
        ...
        public void BuildArchive(string arcPath, string workingPath)
        {
            ...
            {
                byte[] array = global::ARC.Workers.ARC.FileUtils.smethod_0(text);
            ...
            foreach (global::ARC.Workers.ARC.ArcEntry arcEntry in list)
            {
                arcEntry.Pos += num;
            }
        ...
        private global::System.IO.MemoryStream method_3(global::System.Collections.Generic.List<global::ARC.Workers.ARC.ArcEntry> list_0)
        {
...
namespace ARC.Workers.ARC
{
    public class FileUtils
    {
        ...
        internal static string smethod_1(string string_0, string string_1, string string_2, string string_3 = "")
        {
            ...
            string result = null;
            string_2 = global::ARC.Workers.ARC.FileUtils.smethod_2(string_2);
        ...
        public static byte[] ReadBytes(global::System.IO.BinaryReader reader, int fieldSize, global::ARC.Workers.ARC.FileUtils.ByteOrder byteOrder)
        {
            byte[] array = new byte[fieldSize];
            if (byteOrder == global::ARC.Workers.ARC.FileUtils.ByteOrder.LittleEndian)
            {
        ...
        public static uint smethod_6(global::System.IO.BinaryReader reader, global::ARC.Workers.ARC.FileUtils.ByteOrder byteOrder)
        {
            if (byteOrder == global::ARC.Workers.ARC.FileUtils.ByteOrder.LittleEndian)
            {
                return (uint)reader.ReadInt32();
            }
            return global::System.BitConverter.ToUInt32(global::ARC.Workers.ARC.FileUtils.ReadBytes(reader, 4, global::ARC.Workers.ARC.FileUtils.ByteOrder.BigEndian), 0);
        }

        public static void smethod_7(global::System.IO.BinaryWriter writer, uint value, global::ARC.Workers.ARC.FileUtils.ByteOrder byteOrder)
        {
            byte[] array = global::System.BitConverter.GetBytes(value);
            if (byteOrder == global::ARC.Workers.ARC.FileUtils.ByteOrder.BigEndian)
            {
        ...
        {
            folderPath = global::ARC.Workers.ARC.FileUtils.CheckFolderSep(folderPath);
        ...
        internal static void smethod_12(string string_0, string string_1)
        {
            if (global::System.IO.File.Exists(string_0))
            {
                ...
                {
                    global::ARC.Workers.ARC.FileUtils.smethod_10(string_1);
                }
        ...
        public static void CopyFoldersAndFiles(string source, string target)
        {
            ...
            global::ARC.Workers.ARC.FileUtils.CopyFoldersAndFiles(source2, target2);
        }
        ...
        public static void CopyFoldersAndFiles(global::System.IO.DirectoryInfo source, global::System.IO.DirectoryInfo target)
        {
            ...
            {
                global::ARC.Workers.ARC.FileUtils.CopyFoldersAndFiles(directoryInfo, target.CreateSubdirectory(directoryInfo.Name));
            }
